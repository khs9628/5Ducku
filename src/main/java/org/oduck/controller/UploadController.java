...
import org.oduck.domain.AttachFileDTO;
...
public class UploadController {
	...
	(@RequestHeader("User-Agent")String userAgent, String fileName) {
		Resource resource = new FileSystemResource("/usr/local/tomcat9/webapps/upload" + fileName);
	...
	@ResponseBody
	public ResponseEntity<String> delelteFile(String fileName, String type) {
		...
		try {
			 ...
			 */
			  file = new File("/usr/local/tomcat9/webapps/upload/" + URLDecoder.decode(fileName, "UTF-8"));
